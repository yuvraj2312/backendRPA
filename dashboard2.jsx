...
const Dashboard = () => {
  ...
  const fetchData = async (page = 1) => {
    try {
      ...
      setKpis({ success: successCount, fail: failedCount });
      setBarData({ labels: barLabels, data: barData });
      setLineData({ labels: lineLabels, data: lineData });
      setDropdowns({ process_names: processNames, usernames: userNames, domains: domainNames });
