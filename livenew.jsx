...
const LivePage = () => {
  ...
  const handleExportCSV = () => {
    const rows = [
      ["Domain", "Process Name", "Process Owner", "Stage", "Go Live"],
      ...data.map((r) => [r.domain, r.process, r.owner, r.stage, r.goLive]),
    ];
  ...
  const handleExportPDF = () => {
    const doc = new jsPDF();
    autoTable(doc, {
      head: [["Domain", "Process Name", "Process Owner", "Stage", "Go Live"]],
      body: data.map((r) => [r.domain, r.process, r.owner, r.stage, r.goLive]),
    });
              ...
              <>
                <table className="min-w-full divide-y divide-gray-200 text-base text-left" ref={tableRef}>
                  <thead className="bg-red-500 text-white">
                    <tr>
                      {["Domain", "Process Name", "Process Owner", "Stage", "Go Live"].map((h, i) => (
